                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40" method="post" action="/admin/profile.php/?id=<?php echo $accountInfo['id']; ?>&access_token=<?php echo admin::getAccessToken(); ?>">
                            ...
                            <div class="card-block little-profile text-center">
                                ...
                                <?php
                                    ...
                                    if (strlen($accountInfo['coverUrl']) != 0) {
                                        ...
                                        ?>
                                            <p><a href="/admin/profile.php/?id=<?php echo $accountInfo['id']; ?>&access_token=<?php echo admin::getAccessToken(); ?>&act=delete-cover">Delete Cover</a></p>
                                        <?php
                                    ...
                                    if (strlen($accountInfo['lowPhotoUrl']) != 0) {
                                        ...
                                        ?>
                                            <p><a href="/admin/profile.php/?id=<?php echo $accountInfo['id']; ?>&access_token=<?php echo admin::getAccessToken(); ?>&act=delete-photo">Delete Photo</a></p>
                                        <?php
